...
CREATE TABLE IF NOT EXISTS cases (
  ...
  "longitude" numeric,
  "addressNote" text,
  "buildingContext" text,
  "leakSymptoms" text,
  "leakSourceDiagnosis" text,
  "accessConstraints" text,
  "status" text,
  "zones" jsonb DEFAULT '[]'::jsonb,
  "specialNote" text,
  "formalQuotedPrice" numeric DEFAULT 0,
  "quoteVersion" numeric DEFAULT 1,
  "manualPriceAdjustment" numeric DEFAULT 0,
  "depositPercentage" numeric DEFAULT 0.7,
  "depositReceivedDate" text,
  "finalPaymentReceivedDate" text,
  "invoiceTitle" text,
  "invoiceTaxId" text,
  "paymentNote" text,
